...
HeaderComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: HeaderComponent, selectors: [["app-header"]], decls: 4, vars: 0, consts: [[1, "border-bottom", "pb-2", "pt-2", 2, "display", "flex", "flex-direction", "row", "align-items", "center"], [1, "text-white", "mt-1", "font-weight-bold"]], template: function HeaderComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](3, "Card Manager");
...
AddCardComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({ type: AddCardComponent, selectors: [["app-add-card"]], decls: 38, vars: 3, consts: [[1, "mt-5", "mb-5", "text-right"], ["routerLink", "/", 1, "btn", "btn-success"], [1, "row"], [1, "mt-2", "col-12", "col-md-7"], [2, "width", "100%", "height", "100%", "justify-content", "center", "align-items", "center", "display", "flex"], [3, "payment"], [1, "text-center"], [1, "btn", "btn-sm", "btn-success", 3, "disabled", "click"], [1, "mt-2", "col-12", "col-md-5", "text-dark"], [2, "margin-left", "10px", "margin-right", "10px"], [1, "recent-transactions", "p-3", "pt-5", "pb-5"], [1, "font-weight-bold", "text-dark"], [3, "formGroup"], [1, "font-weight-bold"], ["max", "16", "maxlength", "16", "type", "number", "formControlName", "number", 1, "form-control"], ["type", "text", "formControlName", "name", 1, "form-control"], ["type", "date", "formControlName", "expDate", 1, "form-control"], ["type", "number", "max", "4", "maxlength", "4", "formControlName", "cvv", 1, "form-control"], ["type", "number", "formControlName", "amount", 1, "form-control"]], template: function AddCardComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](24, " Card Holder:");
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](28, " Expiration date:");
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](32, " Cvv:");
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
...
AlertComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AlertComponent, selectors: [["app-alert"]], decls: 1, vars: 1, consts: [["style", "top: 15%;left:5%;position: absolute", "class", "p-2 pl-4 pr-4 rounded bg-secondary text-dark animate__animated animate__slideInDown", 4, "ngIf"], [1, "p-2", "pl-4", "pr-4", "rounded", "bg-secondary", "text-dark", "animate__animated", "animate__slideInDown", 2, "top", "15%", "left", "5%", "position", "absolute"]], template: function AlertComponent_Template(rf, ctx) { if (rf & 1) {
